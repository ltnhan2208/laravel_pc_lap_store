                            ...
                            <form id="form__baocao">
                               ...
                               &emsp;&emsp;
                                 ...
                                 <button id="btnSearch" class="btn btn-outline-dark" type="submit">Tìm</button>
                                  ...
                                  <br/><br/> <br/><br/>
                                  <form action="{{URL::to('them-bao-cao-thu')}}" method="POST">
                                    {{ csrf_field()}}
                         ...
                         <thead>
                                <tr>
                                    ...
                                    <tbody>
                                         <tr>
                                         <td>
                                            <input hidden id="ip__bc--sl" type="number" name="thuSoluong"/>
                                            <span id="text__bc--sl"></span>
                                         </td>
                                         <td>
                                              <input hidden id="ip__bc--tt"type="number" name="thuTongtien"/>
                                              <span id="text__bc--tt"></span>&nbsp;VND
                                         </td>
                                         <td> <input class="ip__ghichu" name="chiGhichu" type="text"  placeholder="Nhập ghi chú nếu có..." /></td>
                                         <td hidden>
                                            <input hidden id="chiNgaybd" name="thuNgaybd" type="date" />
                                            <input hidden id="chiNgaykt" name="thuNgaykt" type="date" />
                                         </td/>
                                     </tr>
                                      <tr>
                                        <td colspan="4">
